...
async function GET(request) {
    ...
    if (code) {
        ...
        if (!error) {
            ...
            if (user) {
                const { data: roles } = await supabase.from('user_roles').select('store_id').eq('user_id', user.id).maybeSingle();
                if (roles?.store_id) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}/dashboard`);
                } else {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}/onboarding`);
                }
            }
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}/auth/auth-code-error`);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__8a208fb2._.js.map