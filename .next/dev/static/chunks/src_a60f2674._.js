...
function createClient() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserClient"])(("TURBOPACK compile-time value", "https://mbvwsrwywzfmkvwcmhmh.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1idndzcnd5d3pmbWt2d2NtaG1oIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzA4NjIyOTQsImV4cCI6MjA4NjQzODI5NH0.1kYGW2HH-S59XZCt9Fn73EN20DM7oxwyddZ-cw0Yi5I"));
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
const sidebarItems = [
    ...
    {
        title: "재고 현황",
        // Renaming '재고 관리' to '재고 현황' to distinguish from Item Master
        href: "/dashboard/inventory",
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"] // Keep Box for Inventory Status
    },
    {
        title: "레시피 관리",
...
function Sidebar(t0) {
    ...
    if ($[0] !== "646be4ae8ed72b05d55cd9459ca0da65f8600d0fa329f45703cdf08ceee86118") {
        for(let $i = 0; $i < 25; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "646be4ae8ed72b05d55cd9459ca0da65f8600d0fa329f45703cdf08ceee86118";
    }
    let t1;
    if ($[1] !== t0) {
        t1 = t0 === undefined ? {} : t0;
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
        $[3] = t2;
    } else {
        t2 = $[3];
    }
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = ({
            "Sidebar[useEffect()]": ()=>{
                const fetchUserInfo = async function fetchUserInfo() {
                    const { data: t5 } = await supabase.auth.getUser();
                    const { user } = t5;
                    if (!user) {
                        return;
                    }
    ...
    if ($[6] !== router) {
        t5 = ({
            "Sidebar[handleSignOut]": async ()=>{
                const { error } = await supabase.auth.signOut();
                if (error) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("\uB85C\uADF8\uC544\uC6C3 \uC911 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4.");
                } else {
        ...
        t7 = sidebarItems.map({
            "Sidebar[sidebarItems.map()]": (item)=>{
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    href: item.href,
                    onClick: onNavigate,
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex items-center gap-3 rounded-lg px-3 py-2 transition-all hover:text-primary", isActive ? "bg-muted text-primary" : "text-muted-foreground"),
                    children: [
    ...
    let t9;
    if ($[14] !== userInfo) {
        t9 = userInfo && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            href: "/dashboard/mypage",
...
_s(Sidebar, "Ifum1qfc1bSKnLlEWJLs0iJ8aSc=", false, function() {
    return [
...
function Sheet(t0) {
    ...
    if ($[0] !== "c53b3dcdf001bedf3c84bb34f1120658158804b0351e7bb7868835671c957824") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c53b3dcdf001bedf3c84bb34f1120658158804b0351e7bb7868835671c957824";
    }
    let props;
    if ($[1] !== t0) {
        ({ ...props } = t0);
...
function SheetContent(t0) {
    ...
    if ($[8] !== className || $[9] !== t4 || $[10] !== t5 || $[11] !== t6 || $[12] !== t7) {
        t8 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500", t4, t5, t6, t7, className);
        $[8] = className;
        $[9] = t4;
        $[10] = t5;
        $[11] = t6;
...
function SheetHeader(t0) {
    ...
    let t1;
    if ($[4] !== className) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex flex-col gap-1.5 p-4", className);
        $[4] = className;
        $[5] = t1;
    } else {
        t1 = $[5];
...
function SheetTitle(t0) {
    ...
    let t1;
    if ($[4] !== className) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-foreground font-semibold", className);
        $[4] = className;
        $[5] = t1;
    } else {
        t1 = $[5];
...
"[project]/src/components/dashboard/mobile-sidebar.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MobileSidebar() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(5);
    if ($[0] !== "af5c3a9b5e94253fe362db269a71c0095d51e6276fb323ef7c0a6c3f396d5d87") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "af5c3a9b5e94253fe362db269a71c0095d51e6276fb323ef7c0a6c3f396d5d87";
    }
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sheet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SheetContent"], {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Sidebar"], {
                onNavigate: {
                    "MobileSidebar[<Sidebar>.onNavigate]": ()=>setOpen(false)
                }["MobileSidebar[<Sidebar>.onNavigate]"]
            }, void 0, false, {
                fileName: "[project]/src/components/dashboard/mobile-sidebar.tsx",
                lineNumber: 27,
                columnNumber: 57
...
//# sourceMappingURL=src_a60f2674._.js.map